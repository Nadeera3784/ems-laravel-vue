    ...
    export default {
      ...
      methods: {
        ...
        async getEmployeeData(id){
          const { data } = await axios.get("/em/employee/edit/"+id);
          this.employee.first_name  = data.employee.first_name;
          this.employee.last_name   = data.employee.last_name;
          this.employee.middle_name = data.employee.middle_name;
          this.employee.address     = data.employee.address;
          this.employee.zip         = data.employee.zip;
          this.employee.department  = data.employee.department_id;
          this.employee.state       = data.employee.state_id;
          this.employee.city        = data.employee.city_id;
          this.employee.country     = data.employee.country_id;
          this.employee.birthdate   = data.employee.birthdate;
          this.employee.date_hired  = data.employee.date_hired;
        },
        ...
        onSubmit: function (e) {
          ...
          if (this.$v.$invalid) {
            ...
            axios.post('/em/employee/update/'+id, this.employee).then((response) => {
